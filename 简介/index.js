$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*欢迎你，我的朋友。我叫华灿宽，是个年轻的菜鸟前端</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*后面加个Sir这个词，并非妄自尊称，纯属卖萌o(￣▽￣)d</div>",2000);
	...
	w.load("<div class='writecode'>华Sir、热爱网络的菜鸟</div></p>");
	w.load("<div class='writecode'>个人主页可获取新浪微博、本人QQ号。</div></p>");
	w.load("<h1 class='writecode'>联系</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>Mail:<a href='javascript:void(0);' target='_blank'>2768038740@qq.com</li>");
	w.load("<li class='writecode'>Blog:<a href='https://www.hsir.cf/' target='_blank'>hsir.cf</a></li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>技能</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>能看懂html+css+javascript</li>");
	w.load("<li class='writecode'>会易语言一些技巧</li>");
    ...
    w.load("<li class='writecode'>}</li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>真实介绍</h1>");
	w.load("<ul>");
    w.load("<li class='writecode'>经常熬夜、爱瞎折腾、英语极差、爱吃醋、独占欲强吧...朋友说的</li>");
    w.load("<li class='writecode'>就读于广东省深圳市宝安区福永中学</li>");
	w.load("</ul>");
	c.load("<p><div class='comment writecode'>/**</div>");
	c.load("<div class='comment writecode'>&nbsp;*好了、左面的简历看起来不是太令人满意，让我们先给他来点动态渲染</div>");
	c.load("<div class='comment writecode'>&nbsp;*/</div></p>");
	...
	c.load("<div class='comment writecode'>&nbsp;*QQ:2768038740</div>");
	c.load("<div class='comment writecode'>&nbsp;*Mail:2768038740@qq.com</div>");
